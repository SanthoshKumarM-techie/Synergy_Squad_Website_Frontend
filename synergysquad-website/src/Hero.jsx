      ...
      <div className='absolute inset-0 bg-gradient-to-b from-black/75 via-black/45 to-black/85 z-10'>
        ...
        <div className='absolute top-1/2 -translate-y-1/2 left-0 right-0 px-8 mx-auto flex justify-between w-full gap-8'>
          <div className='flex flex-col gap-0'>
            <h1 className='text-2xl md:text-4xl lg:text-5xl font-bold text-white tracking-tighter max-w-5xl uppercase'>
              Knowledge Institute of Technology
            </h1>
            <h3 className='text-white font-bold text-2xl md:text-4xl lg:text-5xl uppercase tracking-tighter'>
              Department of Computer Science and Engineering
            </h3>
            <div className='flex gap-3'>
              <h3 className='text-yellow-400 font-bold text-2xl md:text-4xl lg:text-5xl uppercase tracking-tighter'>
                Synergy Squad
              </h3>
              <p className='text-white font-bold text-sm md:text-md lg:text-lg uppercase tracking-tighter'>
                EST. 2021
              </p>
            </div>
          </div>
          <div className='flex flex-col items-start shrink-0 whitespace-nowrap gap-1'>
            <p className='text-white font-medium whitespace-nowrap text-lg tracking-tighter'>75+ Placements in Tier-1 IT</p>
            <p className='text-white font-medium whitespace-nowrap text-lg tracking-tighter'>Tech Discussions Daily</p>
            <p className='text-white font-medium whitespace-nowrap text-lg tracking-tighter'>Coding Challenges Weekly</p>
            <p className='text-white font-medium whitespace-nowrap text-lg tracking-tighter'>Mock Company Specific Tests</p>
          </div>
        </div>

        {/* Bottom Section - Single Paragraph */}
        <div className='absolute bottom-8 left-0 right-0 px-8 text-gray-300 text-base md:text-lg max-w-2xl tracking-tighter leading-tight font-medium'>
          <p>
