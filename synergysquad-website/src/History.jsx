...
import SS3B6 from './assets/SS 3.0 Brouchre 3.png'
import SS3B7 from './assets/SS 3.0 Brouchre 4.png'
import SS3B8 from './assets/SS 3.0 Brouchre 5.png'
        ...
        <section className='min-h-screen px-8 pt-16 pb-16'>
          ...
          <div className='flex gap-8 mt-16'>
            ...
            <div className='mt-16 grid gap-6 md:grid-cols-[minmax(0,25rem)_minmax(0,1fr)]'>
              <h1 className='text-xl md:text-2xl lg:text-3xl max-w-xl font-semibold tracking-tighter sticky top-20 self-start'>Weekly Activity Summary</h1>
                        ...
                        <div className='mt-8'>
                          ...
                          <ul className='mt-2 font-semibold text-sm md:text-md lg:text-lg tracking-tighter leading-tight'>
                            {card.toppers.map((name, i) => (
                              <li key={i} className='mt-1'>{name}</li>
                            ))}
                          </ul>
                        </div>
                      </div>
        ...
        <section className='px-8 pb-16'>
          ...
          >
            ...
            <div className='relative z-10 max-w-3xl'>
              ...
              <p className='text-white font-semibold text-sm md:text-md lg:text-lg tracking-tighter leading-tight'>The second chapter of our journey, where the foundations <br /> of Synergy Squad were laid.</p>
            </div>
          </div>
          ...
          <div className='flex gap-8 mt-16'>
                ...
                <div className='flex gap-8 mt-16'>
                    ...
                    <p className='max-w-4xl font-semibold text-sm md:text-md lg:text-lg tracking-tighter leading-tight mr-32 text-gray-700'>A 3-day intensive program featuring Skill Enhancement Assessments, Knowledge Transfer Sessions, and Interactive Discussions on Programming MCQs to rapidly boost technical capabilities.</p>
                </div>

            <div className='mt-16 grid gap-6 md:grid-cols-[minmax(0,25rem)_minmax(0,1fr)]'>
              <h1 className='text-xl md:text-2xl lg:text-3xl max-w-xl font-semibold tracking-tighter sticky top-20 self-start'>Summary of 7 Mock TCS CodeVita Assessments</h1>
              <div className='max-w-2xl'>
                <ul className='divide-y divide-gray-300 border-t border-gray-300'>
                  <li className='flex items-center justify-between gap-6 py-3 font-semibold tracking-tighter text-gray-900'>
            ...
            <div className='mt-16 grid gap-6 md:grid-cols-[minmax(0,25rem)_minmax(0,1fr)]'>
              <h1 className='text-xl md:text-2xl lg:text-3xl max-w-xl font-semibold tracking-tighter sticky top-20 self-start'>5 Know and Grow Assessments - Summary</h1>
              <div className='max-w-2xl'>
                <ul className='divide-y divide-gray-300 border-t border-gray-300'>
                  <li className='flex items-center justify-between gap-6 py-3 font-semibold tracking-tighter text-gray-900'>
